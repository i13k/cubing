    ...
    return (
        <main className="flex min-h-screen flex-col items-center">
            ...
            <div style={{ display: (value === 0) ? "block" : "none", paddingTop: 16 }}>
                ...
                <Button variant="contained" color="success" onClick={addContestant}>Dodaj</Button>
            </div>
                                ...
                                names.map(name => (
                                    <TableRow key={name.name}>
                                        ...
                                        <TableCell key={"d"+name.name}>
                                            <IconButton size="medium" onClick={e => {deleteContestant(name.name);}}>
